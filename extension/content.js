...
/********************old**************************************/
onExtensionMessageReceivedOld(message, sender, sendResponse){
  if(!message){
        console.error("empty message is received");
        sendResponse({messageType:"error", content:"empty"});
        return;
  }
      ...
      var response=this.requestConnect(message);
      sendResponse(response);
  }
  else if(message.action==='onPopWindowOpenned'){
      ...
      var response=this.onPopWindowOpenned(message);
      sendResponse(response);
  }
  else if(message.action==='sendInputMessage'){
